<div class="container height-fix">
	<?php
		...
		{
			echo "Please login first to view your account details.";
		}
	...
	?>
	<h2 class="text-center text-muted mb-5">Update My Details</h2>
	...
	<form action="/view/processform.php" method="post">
					...
					<input type="hidden" name="customer_id" value="<?php echo $_SESSION['customer_id']; ?>">
						...
						if(isset($_SESSION['staff_id']))
						{
							...
							<select required name="membership" id="membership" class="form-control">
								<option ';
							if($customer['membership'] == 'standard'){echo "selected ";}
							echo ' value="standard">Standard (FREE)</option>
							<option ';
							if($customer['membership'] == 'vip'){echo "selected ";}
							echo ' value="vip">VIP ($45/year)</option>
							</select>
						</div>';
						}
						elseif(isset($_SESSION['customer_id']))
						{
							...
							<div class="form-group">
								<label for="membership">Membership<sup> *</sup></label>
								<input type="text" class="form-control text-uppercase" name="membership" readonly value="';
								if($customer['membership'] == 'vip'){echo "vip";}else{echo "standard";}
							echo '">
							</div>';
						}
						?>
		...
		<div class="row pb-5">
			<div class="col text-center mt-5">
				<a href="/?page=customerprofile&action=accountoverview" class="btn btn-success btn-lg mx-2">
