...
class MySQL_Report_Class extends FPDF
{
    ...
    public function connect($host = 'localhost', $username = '', $password = '', $db = '')
    {
    ...
    public function mysql_report($query, $dump = false, $attr = array())
    {
